...
- [My Involvement](#my-involvement)
	...
	- [The most challenging part](#the-most-challenging-part)
	- [Possible improvements](#possible-improvements)
		- [Encoding algorithms](#encoding-algorithms)
	- [Integration Test for OpenSource BIRT report viewer](#integration-test-for-opensource-birt-report-viewer)
...
## Overview
* Our product begins with the report designer, where you can design XML-based report files by dragging and dropping. 
* The first step in rendering the report is to connect to the data source and retrieve the data. 
* Then all kinds of data transformation such as filtering, grouping and slicing are applied to the data. 
* After data is ready, all report items such as charts, cross tabs, pivot tables could be generated.
